    ...
    <form action="{{ route('posts.update', ['post_id' => $post->id]) }}" method="post">
        ...
        <div class="form-group">
            ...
            <select name="type_id" class="form-control" id="type_id">
                ...
                <option value="{{ $post_type->id }}" {{ old('type_id', $post->type_id) == $post_type->id ? "SELECTED" : null }} >{{ $post_type->name }}</option>
                @endforeach
            </select>
        </div>
        <div class="form-group">
            ...
            <select name="genre_id" class="form-control" id="genre_id">
                ...
                <option value="{{ $post_genre->id }}" {{ old('genre_id', $post->genre_id) == $post_genre->id ? "SELECTED" : null }} >{{ $post_genre->name }}</option>
                @endforeach
            </select>
        </div>
